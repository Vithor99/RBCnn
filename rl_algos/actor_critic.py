...
class ActorCritic(nn.Module):
    ...
    def __init__(self, input_dim=2, architecture_params=None, output_dim=1, lr=1e-3, beta=0.99, epsilon=0.0, batch_size=128, alpha=0, gamma=0, psi=0, learn_std=True, device=None):
        ...
        self.policy_net = StochasticPolicyNetwork(input_dim, architecture_params, output_dim, alpha=alpha, gamma=gamma, psi=psi, learn_std=learn_std)
    ...
    def update(self):
        ...
        with torch.no_grad():
            ...
            target_values = rewards + terminal * self.beta * next_state_values
